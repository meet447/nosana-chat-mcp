    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background">
            <div className="relative flex flex-col items-center gap-8">
                {/* Ambient Glows */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-brand/10 rounded-full blur-[100px] pointer-events-none" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150px] h-[150px] bg-brand/20 rounded-full blur-[60px] pointer-events-none" />
                ...
                >
                    <div className="space-y-1">
                        <h2 className="text-2xl font-bold tracking-[0.2em] text-foreground/90 uppercase">
                            Nosana <span className="text-brand">Chat</span>
                        </h2>
                    ...
                    <div className="flex gap-2.5 mt-2">
                        {[0, 1, 2].map((i) => (
                            <m.div
                                ...
                                className="h-1.5 w-1.5 rounded-full bg-brand shadow-[0_0_8px_rgba(34,197,94,0.8)]"
                            />
                        ))}
                    </div>
                </m.div>
